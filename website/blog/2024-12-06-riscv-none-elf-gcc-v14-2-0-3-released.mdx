...
seo_title: Version 14.2.0-3 released
description: Version 14.2.0-3 is a maintenance release.
keywords:
  - xpack
  - riscv-none-elf-gcc
  - release
...
- [[#38](https://github.com/xpack-dev-tools/riscv-none-elf-gcc-xpack/issues/38)]:
based on users requests, two more libraries were added
  - `rv32ec/ilp32e`
  - `rv32imc/ilp32`
