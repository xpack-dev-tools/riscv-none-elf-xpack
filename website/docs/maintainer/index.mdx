...
- determine the version (like <code>14.2.0-3.1</code>)
...
Determine the version (like <code>14.2.0-3</code>)
...
and fix them; assign them to a milestone (like <code>14.2.0-3</code>).
...
- commit with the message _**website: blog post release 14.2.0-3 published**_
...
- switch to https://xpack-dev-tools.github.io/riscv-none-elf-gcc-xpack/docs/maintainer/#update-the-xpack-branch
...
- paste the release name like _**xPack GNU RISC-V Embedded GCC v14.2.0-3 released**_
...
[![npm (scoped)](https://img.shields.io/npm/v/@xpack-dev-tools/riscv-none-elf-gcc)](https://www.npmjs.com/package/@xpack-dev-tools/riscv-none-elf-gcc/)
[![npm](https://img.shields.io/npm/dm/@xpack-dev-tools/riscv-none-elf-gcc)](https://www.npmjs.com/package/@xpack-dev-tools/riscv-none-elf-gcc/)
  - all releases [![npm](https://img.shields.io/npm/dt/@xpack-dev-tools/riscv-none-elf-gcc)](https://www.npmjs.com/package/@xpack-dev-tools/riscv-none-elf-gcc/)
