...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/\@pack-dev-tools/riscv-none-elf-gcc/14.2.0-3.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/\@pack-dev-tools/riscv-none-elf-gcc/14.2.0-3.1/.content/bin:$PATH
`} </CodeBlock>
...
<li><code>xpack-riscv-none-elf-gcc-14.2.0-3-linux-arm.tar.gz</code></li>
</ul>
